	...
	<div class="banner-bootom-w3-agileits">
		<div class="container">
			...
			<div class="col-md-5 single-right-left ">
				<div class="grid images_3_of_2">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="<?php echo base_url('uploads/'.$product->product_img); ?>">
								<div class="thumb-image">
									<img src="<?php echo base_url('uploads/'.$product->product_img); ?>" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="<?php echo base_url('uploads/'.$product->product_img); ?>">
								<div class="thumb-image">
									<img src="<?php echo base_url('uploads/'.$product->product_img); ?>" data-imagezoom="true" class="img-responsive" alt=""> </div>
			...
			<div class="col-md-7 single-right-left simpleCart_shelfItem">
				<h3><?php echo $product->name; ?> - <?php echo $product->product_dimension; ?></h3>
				<div class="rating1">
					...
					<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
						...
						<form method="post"
										action="<?php echo base_url('product/insert_cart_data'); ?>" >
											...
											<button class="button" style="background-color:#1accfd; padding: 5px; color: white; border:1px solid #1accfd">Add to cart</button> 
										</form>
					</div>
